...
IBM offre molte sottoreti IP per fornire i servizi e supportare i sistemi per l'esecuzione nel data center. Ad esempio, i servizi del resolver DNS sono in esecuzione in `10.0.80.11` e `10.0.80.12`. Le altre sottoreti sono utilizzate durante il provisioning e il supporto. Puoi trovare gli intervalli IP nei data center [qui](https://console.bluemix.net/docs/infrastructure/hardware-firewall-dedicated/ips.html).
