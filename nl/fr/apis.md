...
# Référence d'API pour {{site.data.keyword.vra_full}}
...
Comme les API SLAPI se réfèrent aux API {{site.data.keyword.vra_full}}, voir les ressources suivantes dans SoftLayer Development Network (SLDN) :
