...
| 문제 번호 | 우선순위 |요약 |
| --- | --- | --- |
| VSE-9525 | 낮음 | 버전 표시에 “SMBIOS” 오류 메시지가 제공됨 |
...
| VSE-9891 |해당사항 없음 | DLA-1323-1 | Debian DLA-1323-1: tzdata - security update |
...
| 문제 번호 | 우선순위 |요약 |
| --- | --- | --- |
| VSE-9880 | 낮음 | RPF 소스 유효성 검증을 사용 안함으로 설정하면 모든 인터페이스의 설정이 제거되지 않음 |
...
| VSE-9883 |해당사항 없음 | DLA-1291-1 | Debian DLA-1291-1: tzdata new upstream version | 
...
| 문제 번호 | 우선순위 |요약 |
| --- | --- | --- |
| VSE-9866 | 낮음 | IPsec 순서를 벗어난 인바운드 오류 |
